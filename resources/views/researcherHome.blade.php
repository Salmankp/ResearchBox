...
<body>
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a href="index.html">
							...
							<h2><a href="#intro"> <font style="color:#9561e2">R</font><font style="color:#6c757d">esearch</font><font style="color:#9561e2">B</font><font style="color:#6c757d">ase</font></a></h2>
						</a>
					</div>
					<!-- /Logo -->
				...
				<ul class="main-nav nav navbar-nav navbar-right">
					...
					<li class="has-dropdown"><a href="#category">Category</a>
						<ul class="dropdown">
							<li><a href="blog-single.html">Add category</a></li>
							<li><a href="blog-single.html">Add category</a></li>
							<li><a href="blog-single.html">Add category</a></li>
						</ul>
					</li>
					<li><a href="#team">Team</a></li>
				 <li> <img src="../img/boss.png" height="40px" width="45px"><a href="{{route('my-home')}}"></li>
				</ul>
				<!-- /Main navigation -->
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							<h1 class="white-text">Researcher Home</h1>
							<p class="white-text">Discover scientific knowledge, and make your research visible.
							</p>
							<button class="white-btn" style="background-color:lightgrey"><a href="{{ url ('my-home') }}">Move To Profile!</a></button>
						</div>
					</div>
					<!-- /home content -->
	...
	<div id="Researches" class="section md-padding">
