	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<section class="jumbotron text-center mt" style="background-color: #9400D3;"> <!-- #8A2BE2 -->
				<div class="container">
					<h1 class="jumbotron-heading" style="color: white">Upload Your Advertisement</h1>

				</div>
			</section>

			<form class="contact100-form validate-form" action="api/advertisement/{{$researcher->id}}" enctype="multipart/form-data" method="POST">
				@csrf
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter Your Email (e@a.x)">
					...
					<input class="input100" type="text" name="email" value="{{$researcher->email}}">
				</div>

				<div class="wrap-input100 bg1 rs1-wrap-input100">
					<span class="label-input100">Phone</span>
					<input class="input100" name="phone" value="{{$researcher->phone}}">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Your Designation">
					...
					<input class="input100" type="text" name="designation" value="{{$researcher->position}}">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Advertisement Name">
					...
					<input class="input100" type="text" name="advertisement_name" placeholder="Advertisement Name ">
				</div>
			...
			<div class="wrap-input100 input100-select bg1">
				...
				<br />
					...
					<div class="container-contact100-form-btn">
						...
						<button class="btn btn-primary" type="submit" value="submit" onclick="window.location.href='/api/advertisement/{{$researcher->id}}'" />Submit</button>
					</div>
			</form>
			</div>
		</div>
