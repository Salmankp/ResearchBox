...
<style>
	...
	// javascript fucntion
	function rpType10() {
        var co = document.getElementById("rptype10");
        var ct = co.options[co.selectedIndex].value;
        // alert(ct);
        if (ct == "re1") {
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<section class="jumbotron text-center mt" style="background-color: #9400D3;"> <!-- #8A2BE2 -->
				<div class="container">
					<h1 class="jumbotron-heading" style="color: white">Upload Article</h1>

				</div>
			</section>


			@if (session('isbn_error'))
			<div class="alert alert-danger">
			ERROR:: {{ session('isbn_error') }}!!
			</div>
			 @endif


			<form class="contact100-form validate-form" action="/api/researchpaper/{{$researcher->id}}" enctype="multipart/form-data" method="post">
				@csrf
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Your Name">
					...
					<input class="input100" type="text" name="researcher_name" value="{{$researcher->name}}" readonly>
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter Your Email (e@a.x)">
					<span class="label-input100">Researcher Email *</span>
					<input class="input100" type="text" name="email" value="{{$researcher->email}}" readonly>
				</div>

				<div class="wrap-input100 bg1 rs1-wrap-input100">
					<span class="label-input100">Phone</span>
					<input class="input100"  name="phone" value="{{$researcher->phone}}" readonly>
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Your Designation">
					...
					<input class="input100" type="text" name="designation" value="{{$researcher->position}}" readonly>
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Research Paper Name">
					...
					<input class="input100" type="text" name="article_name" placeholder="Research Paper Name ">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Isbn number">
					<span class="label-input100">Isbn</span>
					<input class="input100" type="number" name="isbn" value="" placeholder="Enter Isbn Number">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Research Paper Name">
					<span class="label-input100">Research paper title <span>
					<input class="input100" type="text" name="article_title" placeholder="Research Paper Title ">
				</div>
				...
				<!-- Co Author -->
					 ...
					 <span class="label-input100">Number of Co Authors*</span>
					 <div>
						 <select class="js-select3" name="co_authors" id="rptype10" onchange="rpType10();" required>
							 <option value="" disabled="" selected="" hidden="">Choose Number of Authors...</option>
				 ...
				 <div class="wrap-input100 validate-input bg1" data-validate="Please Type Second Researcher Name">
					 <span class="label-input100"> Second Author Name *</span>
					 <input class="input100" type="text" name="co_author1" placeholder="Enter Name">
				 </div>
				 <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter Researcher Email (e@a.x)">
					 <span class="label-input100">Second Author Email *</span>
					 <input class="input100" type="email" name="co_author1_email" placeholder="Enter Email ">
				 </div>

				 <div class=" wrap-input100 validate-input bg1 rs1-wrap-input100" >
					 <span class="label-input100">Second Author Designation *</span>
					 <input class="input100" type="text" name="co_author1_designation" placeholder="Enter Designation">
				 </div>


					<div class="wrap-input100 validate-input bg1" data-validate="Please Type Third Researcher Name">
					 <span class="label-input100"> Third Author Name *</span>
					 <input class="input100" type="text" name="co_author2" placeholder="Enter Name">
				 </div>
				 <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter Researcher Email (e@a.x)">
					 <span class="label-input100">Third Author Email *</span>
					 <input class="input100" type="email" name="co_author2_email" placeholder="Enter Email ">
				 </div>

				 <div class=" wrap-input100 validate-input bg1 rs1-wrap-input100">
					 <span class="label-input100">Third Author Designation *</span>
					 <input class="input100" type="text" name="co_author2_designation" placeholder="Enter Designation">
				 </div>
			...
			<div>
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Publisher">
					<span class="label-input100">Publisher *</span>
					<input class="input100" type="text" name="journal_publisher" placeholder="Publisher ">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Publishing Date">
					<span class="label-input100">Publishing Date *</span>
					<input class="input100" type="date" name="journal_publish_date" placeholder="Publishing Date ">
				</div>


			<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate=" Location">
				<span class="label-input100">Location *</span>
				<input class="input100" type="text" name="conference_location" placeholder=" Location ">
			</div>


			<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Institution">
				<span class="label-input100">Institution *</span>
				<input class="input100" type="text" name="institution" placeholder="Institution ">
			</div>
				...
				<!-- <div id="nat">
					<div class="wrap-input100 input100-select bg1">
						...
						<div>
							<select class="js-select3" name="institute" id="uni" onchange="func();" required>
				...
				<!-- <div id="inter">
					<div class="wrap-input100 input100-select bg1">
						...
						<div>
							<select class="js-select3" name="institute" id="uni2" onchange="func2();" required>
								<option value="" disabled="" selected="" hidden="">Choose University...</option>
					...
					<span class="label-input100"> Upload Your Research Paper *</span>
					<br />
					<br />
					...
					<div class="container-contact100-form-btn">
						...
						<button class="btn btn-primary" type="submit" value="submit" onclick="window.location.href='/api/researchpaper/{{$researcher->id}}'" />Submit</button>
					</div>
			</form>
			</div>
		</div>
...
<!--===============================================================================================-->
	<script src="{{URL::asset('/js/mainf.js')}}"></script>
