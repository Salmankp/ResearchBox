	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<section class="jumbotron text-center mt" style="background-color: #9400D3;"> <!-- #8A2BE2 -->
				<div class="container">
					<h1 class="jumbotron-heading" style="color: white">Upload Your Survey</h1>

				</div>
			</section>

			<form class="contact100-form validate-form" action="api/survey/{{$researcher->id}}" enctype="multipart/form-data" method="POST">
				@csrf
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Survey Name">
					...
					<input class="input100" type="text" name="survey_name" placeholder="Survey Name ">
				</div>
				...
				<!-- <div id="inter">
					...
					<div class="container-contact100-form-btn">
						...
						<button class="btn btn-primary" type="submit" value="submit" onclick="window.location.href='/api/survey/{{$researcher->id}}'" />Submit</button>
					</div>
			</form>
			</div>
		</div>
