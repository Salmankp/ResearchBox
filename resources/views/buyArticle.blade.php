	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<section class="jumbotron text-center mt" style="background-color: #9400D3;"> <!-- #8A2BE2 -->
				<div class="container">
					<h1 class="jumbotron-heading" style="color: white">Buy Article</h1>

				</div>
			</section>

			<form class="contact100-form validate-form" action="/buy-article/{{$researchpaper->id}}/{{$searcher_id}}" enctype="multipart/form-data" method="POST">
				@csrf
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100">
					<span class="label-input100">Article Name</span>
					<input class="input100" name="article_name" value="{{$researchpaper->article_name}}">
				</div>
		       <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Type Your Name">
					<span class="label-input100">Researcher Name *</span>
								<input class="input100" type="text" name="researcher_name" value="{{$researchpaper->researcher_name}}">
					</div>
					<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter Your Email (e@a.x)">
					<span class="label-input100">Researcher Email *</span>
						<input class="input100" type="text" name="researcher_email" value="{{$researchpaper->email}}">
					</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="searcher Name">
					<span class="label-input100">Follower Name *</span>
					<input class="input100" type="text" name="searcher_name" value="{{$searcher->name}}">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Follower Email">
					<span class="label-input100">Follower Email *</span>
			...
			<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
              ...
              <i class="fa fa-cc-discover" style="color:orange;"></i>
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Account Number">
					<span class="label-input100">Account Number *</span>
					<input class="input100" type="text" name="searcher_account_number" value="">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Article Price">
					<span class="label-input100">Article Price *</span>
					<input class="input100" type="text" name="article_price" value="{{$researchpaper->price}}">
				</div>
