...
<head>
	<title>Conduct Assistance</title>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<section class="jumbotron text-center mt" style="background-color: #9400D3;"> <!-- #8A2BE2 -->
				<div class="container">
					<h1 class="jumbotron-heading" style="color: white">Conduct Your Assistance</h1>
				</div>
			</section>

			<form class="contact100-form validate-form" action="/api/conduct-assistance/{{$searcher->id}}" enctype="multipart/form-data" method="POST">
				@csrf
				<!-- <span class="contact100-form-title">
					Conduct Your Assistance
				</span> -->
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100">
					...
					<input class="input100" name="searcher_phone" placeholder="Phone Number">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Your Qualification">
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Assistance Name">
					<span class="label-input100">Assistance Name *</span>
					<input class="input100" type="text" name="assistance_name" placeholder="Assistance Name">
				</div>
				<div class="wrap-input100 validate-input bg1">
					<span class="label-input100">Assistance Description</span>
					<textarea class="md-textarea form-control" rows="3" name="assistance_description"></textarea>
				</div>

			<div class="wrap-input100 validate-input bg1">
				<select class="browser-default custom-select" name="researcher_id">
				  <option selected>Select Researcher</option>
				...
				<!-- <div id="inter">
					...
					<div class="container-contact100-form-btn">
						...
						<button class="btn btn-primary" type="submit" value="submit" onclick="window.location.href='/api/conduct-assistance/{{$searcher->id}}'" />Submit</button>
					</div>
			</form>
			</div>
		</div>
