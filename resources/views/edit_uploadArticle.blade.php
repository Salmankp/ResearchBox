	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<section class="jumbotron text-center mt" style="background-color: #9400D3;"> <!-- #8A2BE2 -->
				<div class="container">
					<h1 class="jumbotron-heading" style="color: white">Edit Article</h1>

				</div>
			</section>

			<form class="contact100-form validate-form" action="/api/researchpaper/{{ $researchpaper->id }}" enctype="multipart/form-data" method="post">
				{{ method_field('PATCH') }}
				@csrf
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Your Name">
					...
					<input class="input100" type="text" name="researcher_name" placeholder="Enter Your Name" value="{{$researchpaper->researcher_name}}">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter Your Email (e@a.x)">
					<span class="label-input100">Researcher Email *</span>
					<input class="input100" type="text" name="email" placeholder="Enter Your Email" value="{{$researchpaper->email}}">
				</div>

				<div class="wrap-input100 bg1 rs1-wrap-input100">
					<span class="label-input100">Phone</span>
					<input class="input100" type="number" name="phone" placeholder="Enter Your Phone No" value="{{$researchpaper->phone}}">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Your Designation">
					...
					<input class="input100" type="text" name="designation" placeholder="Enter Your Designation " value="{{$researchpaper->designation}}">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Research Paper Name">
					...
					<input class="input100" type="text" name="article_name" placeholder="Research Paper Name " value="{{$researchpaper->article_name}}">
				</div>
					...
					<div class="w-full dis-none js-show-service">
						...
						<div id="jj">
							...
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Journal Name">
								...
								<input class="input100" type="text" name="journal_name" placeholder="Journal Name " value="{{$researchpaper->journal_name}}">
							</div>
							...
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Journal Publisher">
								...
								<input class="input100" type="text" name="journal_publisher" placeholder="Journal Publisher " value="{{$researchpaper->journal_publisher}}">
							</div>
							...
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Journal page No">
								...
								<input class="input100" type="number" name="journal_page" placeholder="Journal Page No " value="{{$researchpaper->journal_page}}">
							</div>
							...
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Journal Publishing Date">
								...
								<input class="input100" type="date" name="journal_publish_date" placeholder="Journal Publishing Date " value="{{$researchpaper->journal_publish_date}}">
							</div>
						</div>
						...
						<!-- <div id="cc">
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Conference Name">
								...
								<input class="input100" type="text" name="Conference_name" placeholder="Conference Name " value="{{$researchpaper->conference_name}}">
							</div>
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Conference Date">
								...
								<input class="input100" type="date" name="Conference_date" placeholder="Conference Date " value="{{$researchpaper->conference_date}}">
							</div>
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Conference Location">
								...
								<input class="input100" type="text" name="conference_location" placeholder="Conference Location " value="{{$researchpaper->conference_location}}">
							...
							<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Conference Superviser">
								...
								<input class="input100" type="text" name="conference_supervisor" placeholder="Conference Superviser " value="{{$researchpaper->conference_supervisor}}">
				...
				<!-- <div id="inter">
					...
					<div class="container-contact100-form-btn">
						...
						<input type="submit" value="submit" onclick="window.location.href='/researchpaper'" />
					</div>
			</form>
			</div>
		</div>
