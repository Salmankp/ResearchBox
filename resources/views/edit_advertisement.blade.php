	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<section class="jumbotron text-center mt" style="background-color: #9400D3;"> <!-- #8A2BE2 -->
				<div class="container">
					<h1 class="jumbotron-heading" style="color: white">Edit Your Advertisement</h1>

				</div>
			</section>

			<form class="contact100-form validate-form" action="/api/advertisement/{{$advertisement->id}}" enctype="multipart/form-data" method="POST">
				@csrf
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Your Name">
					...
					<input class="input100" type="text" name="researcher_name" value="{{$advertisement->advertisement_name}}">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter Your Email (e@a.x)">
					<span class="label-input100">Researcher Email *</span>
					<input class="input100" type="text" name="email" value="{{$advertisement->email}}">
				</div>

				<div class="wrap-input100 bg1 rs1-wrap-input100">
					<span class="label-input100">Phone</span>
					<input class="input100" name="phone" value="{{$advertisement->phone}}">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Your Designation">
					...
					<input class="input100" type="text" name="designation" value="{{$advertisement->designation}}">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Advertisement Name">
					<span class="label-input100">Advertisement Name *</span>
					<input class="input100" type="text" name="advertisement_name" value="{{$advertisement->advertisement_name}}">
				</div>
				...
				<div class="wrap-input100 validate-input bg1">
					<label for="form7">Advertisement Description</label>
					<textarea class="md-textarea form-control" rows="3" name="description">{{$advertisement->description}}</textarea>
				</div>
			...
			<div class="wrap-input100 input100-select bg1">
				<span class="label-input100"> Upload Advertisement Picture*</span>
				<br />
				<br />
				<input type="file" name="advertisement_img" accept="image/*">
				<!---------------- End research---------->
				<br />
				<br />
			</div>
					...
					<div class="container-contact100-form-btn">
						...
						<input type="submit" value="submit" onclick="window.location.href='/api/advertisement/{{$advertisement->id}}'" />
					</div>
			</form>
			</div>
		</div>
