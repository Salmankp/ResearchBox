	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<section class="jumbotron text-center mt" style="background-color: #9400D3;"> <!-- #8A2BE2 -->
				<div class="container">
					<h1 class="jumbotron-heading" style="color: white">Edit Your Survey</h1>

				</div>
			</section>

			<form class="contact100-form validate-form" action="/api/survey/{{$survey->id}}" enctype="multipart/form-data" method="POST">
				{{ method_field('PATCH') }}
				@csrf
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Your Name">
					...
					<input class="input100" type="text" name="researcher_name" placeholder="Enter Your Name" value="{{$survey->researcher_name}}">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter Your Email (e@a.x)">
					<span class="label-input100">Researcher Email *</span>
					<input class="input100" type="text" name="email" placeholder="Enter Your Email " value="{{$survey->email}}">
				</div>

				<div class="wrap-input100 bg1 rs1-wrap-input100">
					<span class="label-input100">Phone</span>
					<input class="input100" type="number" name="phone" placeholder="Enter Your Phone No" value="{{$survey->phone}}">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Your Designation">
					...
					<input class="input100" type="text" name="designation" placeholder="Enter Your Designation " value="{{$survey->designation}}">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Survey Name">
					...
					<input class="input100" type="text" name="survey_name" placeholder="Survey Name " value="{{$survey->survey_name}}">
				</div>
				...
				<!-- <div id="inter">
					...
					<div class="container-contact100-form-btn">
						...
						<input type="submit" value="submit" onclick="window.location.href='/survey'" />
					</div>
			</form>
			</div>
		</div>
