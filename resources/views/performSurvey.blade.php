...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="/survey-performed/{{$survey->id}}/{{$survey->researcher_id}}" enctype="multipart/form-data" method="POST">
				@csrf
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Your Name">
					...
					<input class="input100" type="text" name="researcher_name" value="{{$survey->researcher_name}}">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Your Designation">
					<span class="label-input100">Researcher Designation *</span>
					<input class="input100" type="text" name="designation" value="{{$survey->designation}}">
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Survey Name">
					<span class="label-input100">Survey Name *</span>
					<input class="input100" type="text" name="survey_name" value="{{$survey->survey_name}}">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Searcher Name">
					<span class="label-input100">Searcher Name *</span>
					<input class="input100" type="text" name="searcher_name" value="{{$searcher->name}}">
				</div>
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Searcher Email">
					...
					<input class="input100" type="text" name="searcher_email" value="{{$searcher->email}}">
				</div>
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Searcher Qualification">
					...
					<input class="input100" type="text" name="searcher_qualification" placeholder="Qualification">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Searcher Age">
					<span class="label-input100">Searcher Age *</span>
					<input class="input100" type="text" name="searcher_age" placeholder="Age">
				</div>

				<div class="wrap-input100 validate-input bg1">
					<span class="label-input100">Searcher Description</span>
					<textarea class="md-textarea form-control" rows="3" name="searcher_description"></textarea>
				</div>
				...
				<!-- <div id="inter">
					...
					<span class="label-input100"> Upload Your Survey *</span>
					<br />
					<br />
					...
					<div class="container-contact100-form-btn">
						...
						<button class="btn btn-primary" type="submit" value="submit" onclick="window.location.href='/survey-performed/{{$survey->id}}/{{$survey->researcher_id}}'" />Submit</button>
					</div>
			</form>
			</div>
		</div>
